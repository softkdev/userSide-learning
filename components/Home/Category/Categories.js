...
const Categories = () => {
  return (
    <div className="container grid grid-cols-4 gap-6 mx-auto -mt-20">
      <div className="bg-white flex flex-col items-center justify-around py-10 border-solid border border-gray ">
      ...
      <div className="bg-white flex relative flex-col items-center justify-around py-10 border-solid border border-gray ">
