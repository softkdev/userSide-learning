      ...
      <div className="bg-green flex flex-col items-center py-16">
        ...
        <div className="container mt-5">
          <div className="flex w-4/12 mx-auto">
            <input
              type="text"
              className="w-9/12 ml-3 placeholder-shown:text-gray-500 text-right px-5 py-2 bg-white text-dark"
      ...
      <div className="bg-dark py-16">
        <div className="container mx-auto grid grid-cols-4 gap-6">
          <div className="text-right">
            ...
            <p className="text-justify text-md font-light text-gray-500">
          ...
          <div className="text-right">
            ...
            <div>
              <div className="flex mt-5 justify-between items-stretch">
                <div className="w-4/12 bg-gray-500  ml-8"></div>
          ...
          <div className="text-right">
            ...
            <div className="grid grid-cols-2 gap-1">
              <div>
                <p className="mt-3 text-base font-light text-gray-500 text-right">
                  لورم اپیسوم
                </p>
                <p className="mt-3 text-base font-light text-gray-500 text-right">
                  لورم
