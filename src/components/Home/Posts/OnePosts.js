...
const OnePosts = () => {
  return (
    <div className="border w-full border-solid min-h-72 mt-5 border-gray-500 flex">
      ...
      <div className="w-7/12 py-5 pr-12 pl-5">
        <h5 className="text-gray-500 text-right font-light text-3xl">
          لورم اپیسوم
        </h5>
        ...
        <p className="text-2xl font-light text-gray-500 mb-5 text-right">
        ...
        <div className="flex justify-between items-end w-full">
          <div className="w-3/12 text-right">
            ...
            <p className="mb-2 text-md font-light text-gray-500">لورم اپیسوم</p>
          </div>
          <div className="w-3/12 text-right">
